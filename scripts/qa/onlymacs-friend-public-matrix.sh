...
check_shell "S101" "Fresh bridge runtime defaults to sharing and using" "rg -q 'Mode:[[:space:]]+\"both\"' '$ROOT_DIR/apps/local-bridge/internal/httpapi/runtime.go'"
check_shell "S102" "Fresh bridge runtime defaults to OnlyMacs Public" "rg -q 'ActiveSwarmID:[[:space:]]+defaultPublicSwarmID' '$ROOT_DIR/apps/local-bridge/internal/httpapi/runtime.go'"
check_shell "S103" "Fresh public-sharing runtime default has a unit test" "rg -q 'TestRuntimeStoreDefaultsFreshInstallsToPublicSharing' '$ROOT_DIR/apps/local-bridge/internal/httpapi/runtime_test.go'"
check_shell "S104" "Missing-mode runtime migration keeps public sharing default" "rg -q 'TestRuntimeStoreFillsMissingModeWithPublicSharingDefault' '$ROOT_DIR/apps/local-bridge/internal/httpapi/runtime_test.go'"
check_shell "S105" "Stale requester token public-list fallback has a unit test" "rg -q 'TestCoordinatorSwarmsFallsBackToPublicListWhenStoredRequesterTokenIsStale' '$ROOT_DIR/apps/local-bridge/internal/httpapi/runtime_test.go'"
check_shell "S106" "Status fallback keeps local sharing visible in tests" "rg -q 'TestStatusKeepsLocalSwarmWhenSwarmListTimesOut' '$ROOT_DIR/apps/local-bridge/internal/httpapi/router_test.go'"
check_shell "S107" "App refresh keeps public swarm mode on both" "rg -q 'selectedMode = \\.both' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/BridgeStore+RuntimeOperations.swift'"
check_shell "S108" "App state starts in both mode before first bridge response" "rg -q '@Published var selectedMode: AppMode = \\.both' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/OnlyMacsApp.swift'"
check_shell "S109" "Bridge placeholder models expose both mode during bootstrap" "rg -q 'mode: \"both\"' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/OnlyMacsBridgeModels.swift'"
check_shell "S110" "Bridge placeholder models expose swarm-public during bootstrap" "rg -q 'swarm-public' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/OnlyMacsBridgeModels.swift'"

check_shell "S111" "Installer seeds the public swarm selection" "rg -q 'choice id=\"join-public\".*start_selected=\"true\"' '$ROOT_DIR/scripts/macos-pkg/distribution.xml.tmpl'"
check_shell "S112" "Installer seeds share-this-Mac selection" "rg -q 'choice id=\"share-this-mac\".*start_selected=\"true\"' '$ROOT_DIR/scripts/macos-pkg/distribution.xml.tmpl'"
check_shell "S113" "Installer seeds launch-at-login selection" "rg -q 'choice id=\"run-on-startup\".*start_selected=\"true\"' '$ROOT_DIR/scripts/macos-pkg/distribution.xml.tmpl'"
check_shell "S114" "Installer seeds starter-model selection" "rg -q 'choice id=\"install-starter-models\".*start_selected=\"true\"' '$ROOT_DIR/scripts/macos-pkg/distribution.xml.tmpl'"
check_shell "S115" "Installer public/share/startup/model choices stay hidden" "rg -q 'choice id=\"join-public\" visible=\"false\"' '$ROOT_DIR/scripts/macos-pkg/distribution.xml.tmpl' && rg -q 'choice id=\"share-this-mac\" visible=\"false\"' '$ROOT_DIR/scripts/macos-pkg/distribution.xml.tmpl' && rg -q 'choice id=\"run-on-startup\" visible=\"false\"' '$ROOT_DIR/scripts/macos-pkg/distribution.xml.tmpl' && rg -q 'choice id=\"install-starter-models\" visible=\"false\"' '$ROOT_DIR/scripts/macos-pkg/distribution.xml.tmpl'"
check_shell "S116" "Installer finalizer launches OnlyMacs once after install" "rg -q 'install-launch-once' '$ROOT_DIR/scripts/macos-pkg/package-scripts/finalize.sh'"
check_shell "S117" "Installer postinstall has an open-app fallback" "rg -q '/usr/bin/open -a \"/Applications/OnlyMacs.app\" --args --onlymacs-apply-installer-selections' '$ROOT_DIR/scripts/macos-pkg/postinstall'"
check_shell "S118" "Installer finalizer prepares Sparkle ownership" "rg -q 'prepare-app-for-sparkle-updates' '$ROOT_DIR/scripts/macos-pkg/package-scripts/finalize.sh'"
check_shell "S119" "Package build includes all setup seed packages" "rg -q 'OnlyMacs-seed-public.pkg' '$ROOT_DIR/scripts/macos-pkg/distribution.xml.tmpl' && rg -q 'OnlyMacs-seed-share.pkg' '$ROOT_DIR/scripts/macos-pkg/distribution.xml.tmpl' && rg -q 'OnlyMacs-seed-startup.pkg' '$ROOT_DIR/scripts/macos-pkg/distribution.xml.tmpl' && rg -q 'OnlyMacs-seed-models.pkg' '$ROOT_DIR/scripts/macos-pkg/distribution.xml.tmpl'"
check_shell "S120" "Installer selections can identify public auto-provisioning" "rg -q 'canAutoProvisionWithoutExtraInput' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/InstallerPackageSelections.swift'"

check_shell "S121" "Runtime checks autostart installed Ollama while onboarding" "rg -q 'autostartIfInstalled: true' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/LocalRuntimeSupervisor.swift'"
check_shell "S122" "Ollama app detection covers /Applications" "rg -q '/Applications/Ollama.app' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/LocalRuntimeSupervisor.swift'"
check_shell "S123" "Ollama app detection covers user Applications" "rg -q 'homeDirectoryForCurrentUser.appendingPathComponent\\(\"Applications/Ollama.app\"' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/LocalRuntimeSupervisor.swift'"
check_shell "S124" "Ollama CLI detection covers Homebrew on Apple Silicon" "rg -q '/opt/homebrew/bin/ollama' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/LocalRuntimeSupervisor.swift'"
check_shell "S125" "Ollama CLI detection covers Homebrew on Intel" "rg -q '/usr/local/bin/ollama' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/LocalRuntimeSupervisor.swift'"
check_shell "S126" "Ollama CLI bootstrap runs ollama serve" "rg -q 'arguments = \\[\"serve\"\\]' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/LocalRuntimeSupervisor.swift'"
check_shell "S127" "Ollama CLI bootstrap writes a dedicated log" "rg -q 'ollama\\.log' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/LocalRuntimeSupervisor.swift'"
check_shell "S128" "Ollama CLI bootstrap process is tracked" "rg -q 'ollamaProcess' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/LocalRuntimeSupervisor.swift'"
check_shell "S129" "Tracked Ollama CLI process stops with the app supervisor" "rg -q 'await stop\\(process: ollamaProcess\\)' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/LocalRuntimeSupervisor.swift'"
check_shell "S130" "Manual launch action retries runtime before opening download page" "rg -q 'await ensureRuntimeRunning\\(\\)' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/OnlyMacsApp.swift' && rg -q 'runtimeState\\.ollamaStatus != \\.ready' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/OnlyMacsApp.swift'"

check_shell "S131" "Qwen 2.5 Coder 7B is available as the small starter model" "jq -e '.models[] | select(.id == \"qwen25-coder-7b-q4km\")' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsCore/Resources/model-catalog.v1.json' >/dev/null"
check_shell "S132" "Qwen 2.5 Coder 7B is default-selected for tier4 installs" "jq -e '.models[] | select(.id == \"qwen25-coder-7b-q4km\") | .installer.default_selected_tiers | index(\"tier4\")' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsCore/Resources/model-catalog.v1.json' >/dev/null"
check_shell "S133" "Qwen 2.5 Coder 14B is default-selected for tier3 installs" "jq -e '.models[] | select(.id == \"qwen25-coder-14b-q4km\") | .installer.default_selected_tiers | index(\"tier3\")' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsCore/Resources/model-catalog.v1.json' >/dev/null"
check_shell "S134" "Qwen 2.5 Coder 32B is default-selected for tier2 installs" "jq -e '.models[] | select(.id == \"qwen25-coder-32b-q4km\") | .installer.default_selected_tiers | index(\"tier2\")' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsCore/Resources/model-catalog.v1.json' >/dev/null"
check_shell "S135" "Qwen 3.6 Q8 is default-selected for tier2 high-memory installs" "jq -e '.models[] | select(.id == \"qwen36-35b-a3b-q8_0\") | .installer.default_selected_tiers | index(\"tier2\")' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsCore/Resources/model-catalog.v1.json' >/dev/null"
check_shell "S136" "Public starter Ollama bootstrap is covered by Swift tests" "rg -q 'installerLaunchCanAutoBootstrapOllamaForPublicStarterSetup' '$ROOT_DIR/apps/onlymacs-macos/Tests/OnlyMacsAppTests/OnlyMacsInstallerRuntimeTests.swift'"
check_shell "S137" "Non-public or no-model Ollama bootstrap stays covered by Swift tests" "rg -q 'ollamaAutoBootstrapStaysOffWithoutPublicStarterProvisioning' '$ROOT_DIR/apps/onlymacs-macos/Tests/OnlyMacsAppTests/OnlyMacsInstallerRuntimeTests.swift'"
check_shell "S138" "Installer queue defaults rebuild from selected starter models" "rg -q 'defaultInstallerSelectionIDs' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/BridgeStore+RuntimeOperations.swift' && rg -q 'rebuildInstallerQueue' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/BridgeStore+RuntimeOperations.swift'"
check_shell "S139" "One-click model setup uses Ollama pull API" "rg -q '/api/pull' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/OnlyMacsInstallerRuntime.swift'"
check_shell "S140" "One-click model setup streams pull progress" "rg -q 'stream: true' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/OnlyMacsInstallerRuntime.swift'"

check_shell "S141" "Local share status reconciles publication without a click" "rg -q 'reconcileSharePublication' '$ROOT_DIR/apps/local-bridge/internal/httpapi/local_share.go'"
check_shell "S142" "Publishing into public swarm ensures membership first" "rg -q 'ensurePublicSwarmMembership' '$ROOT_DIR/apps/local-bridge/internal/httpapi/local_share.go'"
check_shell "S143" "Publishing refuses empty local model lists instead of showing false ready" "rg -q 'NO_MODELS_SELECTED' '$ROOT_DIR/apps/local-bridge/internal/httpapi/local_share.go'"
check_shell "S144" "Bridge status exposes sharing state to the app" "rg -q '\"sharing\"' '$ROOT_DIR/apps/local-bridge/internal/httpapi/router.go'"
check_shell "S145" "App automatic sharing publishes when connected and eligible" "rg -q 'automaticSharingAction' '$ROOT_DIR/apps/onlymacs-macos/Sources/OnlyMacsApp/BridgeStore+RuntimeOperations.swift'"
check_shell "S146" "Automatic sharing publish behavior has a Swift test" "rg -q 'automaticSharingPublishesWhenConnectedAndEligible' '$ROOT_DIR/apps/onlymacs-macos/Tests/OnlyMacsAppTests/OnlyMacsAppStatePresentationTests.swift'"
check_shell "S147" "Friend matrix still runs the two-bridge public visibility rehearsal" "rg -q 'make-two-bridge-public-smoke.sh' '$ROOT_DIR/scripts/qa/onlymacs-friend-public-matrix.sh'"
check_shell "S148" "Friend matrix still runs the two-bridge public execution rehearsal" "rg -q 'make-two-bridge-public-execution-smoke.sh' '$ROOT_DIR/scripts/qa/onlymacs-friend-public-matrix.sh'"
check_shell "S149" "Packaged app allows automatic signed Sparkle updates" "[[ '$sparkle_auto_update' == 'true' && '$sparkle_allows_automatic_updates' == 'true' ]]"
check_shell "S150" "Package verifier expands installer payload before release" "rg -q 'pkgutil.*--expand-full' '$ROOT_DIR/scripts/verify-macos-pkg-public.sh'"
